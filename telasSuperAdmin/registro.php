	...
	<div class="container col-sm-6 col-md-6" id="formulario" align="center">      <!-- ------------------------ FORMULARIO DE CADASTRO ------------------------- -->
				<form  method="POST" action="cadastro.php" class="needs-validation">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control " id="umane" placeholder="nome completo" name="nome" maxlength="50" required>
                  ...
                  <div class="form-row">
                    <div class="form-group col-6">
                          ...
                          <input type="email" class="form-control "  placeholder="email" name="email"  minlength="10" maxlength="50" required>
                          <div class="valid-feedback">Válido.</div>
                          <div class="invalid-feedback">Não deixe este campo vazio.</div>
                    </div> 
                 ...
                 <div class="form-row">
                  <div class="form-group col-6">
                   ...
                   <div class="form-group form-check ">
                     	<button type="submit" class="btn btn-warning" id="botao_criarConta">Adicionar</button>
