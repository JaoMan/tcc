...
<hr>
	...
	<div class="boasVindas container"> 
		
			<h2> Crie sua conta no Correio do Bem</h2>
				<p>Ao criar sua conta Correio do Bem, prepare-se para receber e enviar mensagens de apoio, ou até quem sabe cartinhas amorosas s2</p>
                 ...
                 <div class="form-row">
                  <div class="form-group col-6">
                    ...
                    <div class="invalid-feedback">Não deixe este campo vazio.</div>                  
                     ...
                     <?php 
                             /*Mensagem de erro de compartibilidade das senhas*/

                             if (isset($_SESSION['msgSenha'])) {
                          ?>
                            <div class="alert alert-danger" role="alert"> <?php echo $_SESSION['msgSenha']; ?>
